...
hf() {
  ...
  selected_output=$(refresh_history_file | fzf \
    ...
    --bind "ctrl-d:execute-silent(source ~/.bash/functions/history_management.bash && delete_from_history {}) + execute-silent(echo -e '\033[1;31m履歴から削除: {}\033[0m' >&2) + reload(cat \"$history_temp_file\" | awk '!seen[$0]++')"\
